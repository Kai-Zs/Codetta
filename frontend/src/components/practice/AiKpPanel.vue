...
.kp-btn-close {
  ...
  line-height: 1; padding: 2px; color: var(--text-muted, #9ca3af);
}
.kp-btn-close:hover { color: var(--text, #374151); }
.kp-body { flex: 1; overflow-y: auto; padding: 14px; }
.kp-markdown { font-size: 13px; line-height: 1.7; color: var(--text, #374151); }
.kp-state {
...
.kp-skel-line {
  height: 14px; background: var(--skeleton, #e5e7eb); border-radius: 4px; margin-bottom: 10px;
}
...
.kp-chat-msg.assistant .kp-chat-bubble {
  background: var(--bubble-bg, #f3f4f6); color: var(--text, #374151);
}
...
.kp-markdown th, .kp-markdown td {
  border: 1px solid var(--border-color, #e5e7eb); padding: 6px 8px; font-size: 12px;
}
