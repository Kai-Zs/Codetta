<template>
  <div class="flex flex-col items-center justify-center min-h-full px-6 py-12">
    <h2 class="text-lg font-semibold text-gray-800 mb-2">管理员重置 PIN</h2>
    <p class="text-sm text-gray-400 mb-8">输入学号以重置该用户的 PIN</p>
    <input
      v-model="sid"
      maxlength="10"
      placeholder="学号"
      class="w-full px-4 py-3 border border-gray-200 rounded-lg text-center text-lg tracking-widest focus:outline-none focus:border-purple mb-4" />
